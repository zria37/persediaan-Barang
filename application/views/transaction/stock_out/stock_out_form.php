            ...
            <div class="col-md-4 col-md-offset-4">
                <form action="<?= site_url('Stock/process'); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="detail" id="detail" class="form-control" placeholder="Rusak / hilang / kadaluwarsa Etc" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Qty *</label>
                    ...
                    <div class="form-group">
                        ...
                        <button type="reset" class="btn btn-danger"><i class="fa fa-undo"></i>refresh</button>
                    </div>
                </form>
            </div>
        </div>
